...
@section('content')
    ...
    <form method="POST" action="{{route('tags.store')}}">
        ...
        <div class="space-y-12">
            <div>
                <h2 class="text-base font-semibold leading-7 text-gray-900">Add new tag</h2>
                <p class="mt-1 text-sm leading-6 text-gray-600">Create a new tag to assign to a link</p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-emerald-600 sm:max-w-md">
                                <input type="text" name="name" id="name" class="block flex-1 border-0 bg-transparent py-1.5 pl-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="janesmith">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <p class="mt-3 text-sm leading-6 text-gray-600">What is it for?</p>
                    </div>
                </div>
            </div>
